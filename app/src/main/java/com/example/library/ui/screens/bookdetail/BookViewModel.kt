...
class BookDetailViewModel : ViewModel() {
    ...
    fun loadBook(bookId: String) {
        ...
        val similarBooksList = listOf(
            Book(id = "2", title = "Cien años de soledad", author = "Gabriel García Márquez", description = "Description duis aute irure dolor in reprehenderit in voluptate velit.", publicationDate = ""),
            Book(id = "3", title = "Don Quijote de la Mancha", author = "Miguel de Cervantes", description = "", publicationDate = ""),
            Book(id = "4", title = "La metamorfosis", author = "Franz Kafka", description = "", publicationDate = "")
        )
